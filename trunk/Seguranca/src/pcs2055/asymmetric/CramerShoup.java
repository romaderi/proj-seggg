...
public class CramerShoup implements KeyEncapsulation {
    ...
    public BigInteger[] encrypt(BigInteger[] pk, byte[] m) {
        ...
        BigInteger mm = new BigInteger(ByteUtil.append(zero, m, 1, m.length));
        ...
        BigInteger alfa = new BigInteger(ByteUtil.append(zero, resume, 1, resume.length));
    ...
    public byte[] decrypt(String passwd, BigInteger[] cs) {
        ...
        // m = e / (u1^z) mod p
        BigInteger fac = u1.modPow(q.subtract(z), p);
