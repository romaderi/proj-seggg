...
public interface AED {
    ...
    /**
     * Provide a statistically unique initialization vector (IV) for new operation of authenticated encryption with
     * associated data.
     * 
     ...
     * 
     * @return the ciphertext. If cData is null, a new buffer is automatically allocated, otherwise the provided buffer
     *         is returned.
     */
     ...
     * 
     * @return the ciphertext. If mData is null, a new buffer is automatically allocated, otherwise the provided buffer
     *         is returned.
     */
