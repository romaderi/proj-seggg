            ...
            switch(state) { // máquina de estados
                ...
                case SIGMA0:
                    ...
                    if (matcher.matches()) {
                        ...
                        test = new CaseTest();
                        test.setSigma0(ByteUtil.nistStringToByteArray(s));
                ...
                case XOR1:
                    ...
                    if (matcher.matches()) {
                        ...
                        test.setXor1(ByteUtil.nistStringToByteArray(s));
                ...
                case ROUNDS1:
                    ...
                    if (matcher.matches()) {
                        String s = matcher.group(1);
                        test.setPermutation1(ByteUtil.nistStringToByteArray(s));
                ...
                case Z0:
                    ...
                    if (matcher.matches()) {
                        String s = matcher.group(2);
                        test.setZ0(ByteUtil.nistStringToByteArray(s));
                ...
                case SIGMA1:
                    ...
                    if (matcher.matches()) {
                        String s = matcher.group(1);
                        test.setSigma1(ByteUtil.nistStringToByteArray(s));
                ...
                case XOR2:
                    ...
                    if (matcher.matches()) {
                        String s = matcher.group(2);
                        test.setXor2(ByteUtil.nistStringToByteArray(s));
                ...
                case ROUNDS2:
                    ...
                    if (matcher.matches()) {
                        String s = matcher.group(1);
                        test.setPermutation2(ByteUtil.nistStringToByteArray(s));
                ...
                case Z1:
                    ...
                    if (matcher.matches()) {
                        String s = matcher.group(2);
                        test.setZ1(ByteUtil.nistStringToByteArray(s));
