...
public interface KeyEncapsulation {
    ...
    * 
    * @return a Cramer-Shoup public key, i.e. a BigInteger triple (c, d, h).
    */
    ...
    * encryption.
    *
    * @param pk the Cramer-Shoup public key, i.e. a BigInteger triple (c, d, h).
    * @param m the symmetric key (to be left-padded
    * with “0” bits and represented internally as an integer mod p).
    *
    ...
    * of “0” bits), or else null in case of error.
    */
