...
public interface DigitalSignature {
    ...
    */
    void setup(BigInteger p, BigInteger q, BigInteger g,
                HashFunction H, SpongeRandom sr);
    ...
    *         s = r – xe (mod q) for a suitable random nonce
    *         r (mod q).
    */
    ...
    * @param sig the Schnorr signature, i.e. a BigInteger pair sig = (e, s).
    *
